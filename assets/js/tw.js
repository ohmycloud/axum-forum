...
(() => {
  ...
  var P = {
    ...
    "line-width": function (e) {
      return B(e, " ").every(
        (e) =>
          ie(e) || ee(e) || "thin" === e || "medium" === e || "thick" === e,
      );
    },
    image: function (e) {
      let t = 0;
  ...
  var oe = new RegExp(
    `^${J.source}(${["cm", "mm", "Q", "in", "pc", "pt", "px", "em", "ex", "ch", "rem", "lh", "rlh", "vw", "vh", "vmin", "vmax", "vb", "vi", "svw", "svh", "lvw", "lvh", "dvw", "dvh", "cqw", "cqh", "cqi", "cqb", "cqmin", "cqmax"].join("|")})$`,
  );
  function ie(e) {
              ...
              if ("arbitrary" === t.value.kind) {
                ...
                return "color" === (t.value.dataType ?? H(r, ["color"]))
                  ...
                  : [
                      ...
                      y(
                        "--tw-inset-shadow",
                        `inset ${me(r, (e) => `var(--tw-inset-shadow-color, ${e})`)}`,
                      ),
                      y("box-shadow", l),
                    ];
              }
        ...
        if ("@plugin" === e.name) {
          ...
          for (let t of e.nodes ?? []) {
            ...
            let e = B(t.value, ",").map((e) => {
              ...
              if ("{" === e[0] && "}" === e[e.length - 1])
                throw new Error(
                  `Unexpected \`@plugin\` option: Value of declaration \`${j([t]).trim()}\` is not supported.\n\nUsing an object as a plugin option is currently only supported in JavaScript configuration files.`,
                );
              return e;
            });
